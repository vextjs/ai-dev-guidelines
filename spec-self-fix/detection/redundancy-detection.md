...
检测逻辑:
  1. 收集所有确认点定义位置
     - workflows/common/confirmation-points.md (权威)
     - README.md 快速参考
     - CONSTRAINTS.md
...
检测示例:
  文件1: best-practices/compliance-check.md
  文件2: spec-self-fix/detection/xxx.md
  重叠: 都涉及规范检查
...
检测示例:
  概念: "预检查步骤"
  位置1: workflows/00-pre-check/README.md (v2, 3项)
  位置2: 某处旧文档 (v1, 5项)
