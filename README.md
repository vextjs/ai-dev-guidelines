...
1. **预检查** - 执行 4 项必做检查（工作区、任务类型、输出位置、Agent 标识）
...
│   ├── 00-pre-check/                 # 预检查（4 项必做，含 Agent 标识）
...
- 创建日期: 2026-02-11
- 最后更新: 2026-02-27
- v2.3.0 变更: 预检查从 3 项改为 4 项（新增 Agent 标识）；新增日期强制必填规范；新增 analysis-lite 模板；对齐多编辑器/多 Agent 支持策略
- 版本: v2.2.0
