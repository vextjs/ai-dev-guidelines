...
| 🔒 约束体系 | 19 条约束（含报告+记忆自动输出 + 消息驱动记忆触发 + 报告/记忆序号独立） |
...
| templates/lite/ | 100% | 🟢 完成 | 8个精简模板（含 analysis-lite） |
...
**主题**: 入口文件瘦身 + SUMMARY 精简 + 全面审计修复 + 版本号对齐
...
- ✅ templates/README.md 示例补充 NN 序号
