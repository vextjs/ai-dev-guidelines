# 精简版模板 (Lite Templates)

> 适用于小需求（< 5 个文件、单模块）的精简内容模板，生成简洁务实的文档
...
| [refactoring-lite.md](./refactoring-lite.md) | 架构重构 | 5 |
...
| 头部元数据 | 2-3 个 | 6-8 个 |
| 章节数量 | 3-5 个 | 10-15 个 |
| 适用场景 | 小需求（< 5 文件、单模块） | 大需求（>= 5 文件、多模块） |
| 位置 | `core/templates/lite/` | `core/templates/core/` |
