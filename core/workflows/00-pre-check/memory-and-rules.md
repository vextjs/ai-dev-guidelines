...
> **详见**: [task-memory/triggers.md §触发时机](../common/task-memory/triggers.md)
...
AI 自动执行:
  1. 执行完成验证（见 task-memory/triggers.md §任务完成验证）
...
> 完整规范详见 [task-memory/multi-agent.md §多 Agent 支持](../common/task-memory/multi-agent.md)
