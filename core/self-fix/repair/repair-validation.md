...
示例:
  修改文件: core/workflows/decision-tree.yaml
  运行检测:
    - YAML 语法检测 → 通过 ✅
    - 版本一致性检测 → 通过 ✅
    - 引用完整性检测 → 通过 ✅
...
示例:
  修改文件: core/templates/lite/technical-lite.md
  关联文件:
    - core/templates/README.md (引用此文件)
...
验证报告:
  ...
  修复文件: core/workflows/decision-tree.yaml
...
示例:
  修改: core/templates/core/xxx.md → core/templates/lite/xxx.md
  关联影响: 
    - README.md 需要更新路径
