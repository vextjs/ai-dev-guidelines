...
| 编号 | 工作流 | 说明 |
|------|--------|------|
| 09 | [开源项目初始化](./09-opensource-init/) | 创建开源 NPM 包项目 |
| 10 | [深度分析](./10-analysis/) | 深度分析/审查/评估类任务 |
| 11 | [规范自我审查](./11-self-audit/) | 规范体系 15 维度全量深度自审 |

### 质量保障

| 编号 | 工作流 | 说明 |
|------|--------|------|
| 12 | [场景化走查](./12-scenario-walkthrough/) | 模拟用户场景验证规范执行合规性（36 用例） |

> 📌 场景化走查是质量保障工具，不计入"11 种工作流"统计。
